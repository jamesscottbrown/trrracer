...
const verticalAxisOverview = (height, filteredActivities, setDefineEvent, defineEvent, yScale, translateY, svg) => {
  ...
  // React.useEffect(() => {
    ...
    let wrapGroup = checkGroup.empty() ? svg.append('g').attr('class', 'timeline-wrap') : checkGroup;
    
    wrapGroup.selectAll('*').remove();
    wrapGroup.attr('transform', `translate(60, ${translateY})`);
