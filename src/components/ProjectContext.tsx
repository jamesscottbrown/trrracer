  ...
  switch (action.type) {
    case 'SET_DATA': {
     ...
     // getGoogleIds(action.projectData, state);
      ...
      let tfidf_file = fs.readFileSync('/Volumes/GoogleDrive/Shared drives/trrrace/Derya Artifact Trrracer/keywords.json', {encoding: 'utf-8'})
      ...
      let conFile = fs.readFileSync('/Volumes/GoogleDrive/Shared drives/trrrace/Derya Artifact Trrracer/concept_concord_by_entry.json', {encoding: 'utf-8'})
